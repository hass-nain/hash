/*!
 * Hash v1.0.0 (https://hashframework.netlify.app)
 * Authors: Hassnain Haider, Syed Maisam Abbas, Ali Raza
 * Licensed under MIT Github Open Source
 */
...
(function (global, factory) {
      ...
      (function () {
        ...
        _proto.toggle = function toggle() {
          ...
          if (
            ...
            $$$1(parent).closest(Selector.menubar_NAV).length === 0
          ) {
        ...
        _proto._detectNavbar = function _detectNavbar() {
          return $$$1(this._element).closest(".menubar").length > 0;
        };
  ...
  var Modal = (function ($$$1) {
    ...
    var Selector = {
      ...
      NAVBAR_TOGGLER: ".menubar-toggler",
      /**
       * ------------------------------------------------------------------------
       * Class Definition
       * ------------------------------------------------------------------------
      ...
      (function () {
        ...
        _proto._setScrollbar = function _setScrollbar() {
          ...
          if (this._isBodyOverflowing) {
            ...
            $$$1(Selector.menubar_TOGGLER).each(function (index, element) {
              var actualMargin = $$$1(element)[0].style.marginRight;
              var calculatedMargin = $$$1(element).css("margin-right");
              $$$1(element)
                .data("margin-right", actualMargin)
        ...
        _proto._resetScrollbar = function _resetScrollbar() {
          ...
          $$$1(Selector.STICKY_CONTENT + ", " + Selector.menubar_TOGGLER).each(
